...
public class TreasuryApiRangeIntegrationTest {
        ...
        public void convertTransaction_usesMostRecentRateWithinSixMonths() throws Exception {
                ...
                String rateResponse = "{\"data\":[{\"currency_code\":\"EUR\",\"currency_name\":\"Euro\",\"exchange_rate\":\"0.3333\",\"exchange_rate_date\":\"2025-12-03\",\"country_code\":\"EU\"}]}";

                server.expect(requestTo(org.hamcrest.Matchers.containsString("exchange_rate_date")))
